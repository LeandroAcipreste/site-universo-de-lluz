    ...
    return (
        ...
        >
            ...
            <div className="sticky top-[80px] h-[calc(100vh-80px)] w-full flex flex-col md:flex-row overflow-hidden">
                ...
                {/* ── PAINEL ESQUERDO: TEXTOS (OTIMIZADO PARA MOBILE) ── */}
                <div className="relative z-20 flex h-[35%] md:h-full w-full flex-col justify-center px-6 py-4 md:w-1/2 md:px-16 lg:px-24 md:py-12 bg-[#050505]/90 backdrop-blur-sm md:bg-transparent">
                    ...
                    <div className="relative h-[120px] md:h-[300px] w-full flex flex-col justify-center">
                        <AnimatePresence mode="wait">
                            ...
                            >
                                <h3 className="mb-2 md:mb-4 font-headline text-xl font-bold text-white uppercase tracking-tight md:text-5xl">
                                    {currentPrayers[activeIndex]?.title}
                                </h3>
                                <p className="max-w-md text-xs md:text-lg leading-relaxed text-neutral-400 font-light">
                                    {currentPrayers[activeIndex]?.description}
                                </p>

                                <div className="mt-4 md:mt-8 h-[2px] w-full max-w-sm bg-white/10">
                ...
                {/* ── PAINEL DIREITO: CARDS (GANHA ESPAÇO NO MOBILE) ── */}
                <div className="relative h-[65%] w-full bg-[#080808]/50 md:h-full md:w-1/2 border-t md:border-t-0 md:border-l border-white/5">
                    <BackgroundSnake />
